This Python application provides a user-friendly graphical interface for analyzing IP addresses from log files. Built using Tkinter, the program allows users to:
